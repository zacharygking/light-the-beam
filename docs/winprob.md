...
Fitted by `tools/train_winprob.py` on every play of the 2024-25 season (623,853 plays after dropping ESPN's in-feed scoring corrections) and evaluated on every play of 2025-26 (641,199 plays, 1,322 games). ESPN's own in-game win probability, recorded on the same plays, is the benchmark.
...
| a | b_ms | b_s | b_m | eps |
|---|---|---|---|---|
| -0.0137 | 0.0957 | 0.1844 | -0.0111 | 0.005 |
...
| 0.1–0.2 | 35,026 | 0.150 | 0.151 |
| 0.2–0.3 | 41,195 | 0.252 | 0.267 |
| 0.3–0.4 | 53,080 | 0.352 | 0.380 |
| 0.4–0.5 | 73,067 | 0.454 | 0.470 |
| 0.5–0.6 | 90,592 | 0.550 | 0.575 |
| 0.6–0.7 | 79,067 | 0.647 | 0.655 |
| 0.7–0.8 | 58,745 | 0.748 | 0.760 |
| 0.8–0.9 | 52,324 | 0.850 | 0.855 |
| 0.9–1.0 | 91,949 | 0.969 | 0.981 |
